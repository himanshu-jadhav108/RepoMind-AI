...
const KnowledgeGraph3D = dynamic(
  () => import("@/features/architecture-graph/KnowledgeGraph3D"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[460px] bg-card rounded-xl border border-border flex flex-col items-center justify-center font-mono text-xs text-muted-foreground space-y-2">
...
const AGENTS_LIST: AgentDef[] = [
  // Category A: Architecture & Dependency Topology
  {
    id: "planner",
    name: "Planner Agent",
    category: "arch",
    ...
    accentColor: "hsl(var(--category-arch))",
    borderColor: "border-category-arch/40",
    badgeBg: "bg-category-arch/15",
    badgeText: "text-category-arch",
    icon: <Sparkles className="w-4 h-4 text-category-arch" />,
  ...
  },
  {
    ...
    badgeBg: "bg-category-arch/15",
    badgeText: "text-category-arch",
    icon: <Layers className="w-4 h-4 text-category-arch" />,
  ...
  // Category B: Static Analysis & Vulnerability Triage
  {
    id: "security",
    name: "Security Agent",
    category: "security",
    ...
    accentColor: "hsl(var(--category-security))",
    borderColor: "border-category-security/40",
    badgeBg: "bg-category-security/15",
    badgeText: "text-category-security",
    icon: <ShieldCheck className="w-4 h-4 text-category-security" />,
  ...
  },
  {
    ...
    badgeBg: "bg-category-security/15",
    badgeText: "text-category-security",
    icon: <Code2 className="w-4 h-4 text-category-security" />,
  ...
  // Category C: Runtime & IO Performance
  {
    id: "performance",
    ...
    accentColor: "hsl(var(--category-performance))",
    borderColor: "border-category-performance/40",
    badgeBg: "bg-category-performance/15",
    badgeText: "text-category-performance",
    icon: <Zap className="w-4 h-4 text-category-performance" />,
  ...
  // Category D: Verification & Developer Onboarding
  {
    id: "documentation",
    ...
    accentColor: "hsl(var(--category-qa))",
    borderColor: "border-category-qa/40",
    badgeBg: "bg-category-qa/15",
    badgeText: "text-category-qa",
    icon: <FileText className="w-4 h-4 text-category-qa" />,
  ...
  },
  {
    ...
    badgeBg: "bg-category-qa/15",
    badgeText: "text-category-qa",
    icon: <Terminal className="w-4 h-4 text-category-qa" />,
  ...
  },
  {
    ...
    badgeBg: "bg-category-qa/15",
    badgeText: "text-category-qa",
    icon: <GraduationCap className="w-4 h-4 text-category-qa" />,
  ...
  },
  {
    ...
    badgeBg: "bg-category-qa/15",
    badgeText: "text-category-qa",
    icon: <Bot className="w-4 h-4 text-category-qa" />,
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-copper selection:text-white">
      {/* Navigation Header */}
      <header className="w-full border-b border-border bg-card/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Badge variant="outline" className="hidden sm:inline-flex border-border text-muted-foreground font-mono text-xs">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs text-muted-foreground hover:text-foreground transition font-mono flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-card border border-border min-h-[36px]"
            >
      ...
      <main className="flex-1 flex flex-col items-center px-4 pt-8 pb-16 relative">
        <div className="max-w-6xl w-full text-center space-y-6">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded bg-card border border-border text-xs font-mono text-copper shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-6xl font-display font-bold tracking-tight max-w-4xl mx-auto leading-tight text-foreground"
          >
          ...
          <motion.p
            ...
            className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto leading-relaxed font-mono"
          >
          ...
          <motion.div
            ...
            className="w-full max-w-5xl mx-auto rounded-xl bg-card border border-border shadow-2xl overflow-hidden text-left"
          >
            {/* Viewport Control Bar */}
            <div className="panel-header px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs font-mono border-b border-border bg-card">
              <div className="flex items-center gap-2.5">
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse" />
                <span className="font-bold text-foreground tracking-wider">VIEWPORT::3D_KNOWLEDGE_TOPOLOGY</span>
                <span className="text-muted-foreground hidden sm:inline">|</span>
                <span className="text-muted-foreground hidden sm:inline">350 files parsed • 1,200 symbols mapped</span>
              </div>
            ...
            <div className="p-3 bg-background/80 border-b border-border">
              <RepoInputForm />
            </div>

            {/* 3D WebGL Graph Feature Centerpiece */}
            <div className="relative h-[420px] w-full bg-[#121316]">
              <KnowledgeGraph3D />
            </div>
          </motion.div>
          ...
          >
            <div className="p-3 rounded-lg bg-card border border-border flex items-center gap-3 shadow-sm">
              <div className="p-2 rounded bg-category-arch/10 text-category-arch">
                <Layers className="w-4 h-4" />
              </div>
              <div>
                <span className="text-[10px] text-muted-foreground block uppercase">Symbol Parser</span>
                <span className="text-xs font-bold text-foreground">15+ Languages</span>
              </div>
            </div>
            ...
            <div className="p-3 rounded-lg bg-card border border-border flex items-center gap-3 shadow-sm">
              ...
              <div>
                <span className="text-[10px] text-muted-foreground block uppercase">Security Triage</span>
            ...
            <div className="p-3 rounded-lg bg-card border border-border flex items-center gap-3 shadow-sm">
              ...
              <div>
                <span className="text-[10px] text-muted-foreground block uppercase">Profiler</span>
            ...
            <div className="p-3 rounded-lg bg-card border border-border flex items-center gap-3 shadow-sm">
              ...
              <div>
                <span className="text-[10px] text-muted-foreground block uppercase">DAG Engine</span>
          ...
          >
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded border transition ${
                    activeCategoryFilter === "all"
                      ? "bg-copper text-white border-copper font-bold shadow-sm"
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded border transition ${
                    activeCategoryFilter === "arch"
                      ? "bg-category-arch/20 text-category-arch border-category-arch font-bold"
                      : "bg-card text-muted-foreground border-border hover:text-foreground hover:bg-muted"
                  }`}
                >
                  ARCH (3)
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded border transition ${
                    activeCategoryFilter === "security"
                      ? "bg-severity-critical/20 text-severity-critical border-severity-critical font-bold"
                      : "bg-card text-muted-foreground border-border hover:text-foreground hover:bg-muted"
                  }`}
                >
                  SECURITY (2)
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded border transition ${
                    activeCategoryFilter === "perf"
                      ? "bg-severity-warning/20 text-severity-warning border-severity-warning font-bold"
                      : "bg-card text-muted-foreground border-border hover:text-foreground hover:bg-muted"
                  }`}
                >
                  PERF (1)
                ...
                return (
                  <button
                    ...
                    className={`p-2.5 rounded-lg border text-left font-mono transition-all duration-150 flex flex-col gap-1.5 ${
                      isSelected
                        ? `${agent.borderColor} bg-card ${agent.badgeText} shadow-md ring-1 ring-copper/30 scale-[1.02]`
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className={`p-4 sm:p-5 rounded-xl bg-card ${activeAgent.borderColor} border shadow-xl space-y-3 font-mono`}
              >
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border pb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="text-base font-bold text-foreground font-display">{activeAgent.name}</h3>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1 text-[11px]">
                  <span className="text-muted-foreground">Engine Toolkit:</span>
                  {activeAgent.tools.map((tool, idx) => (
                    <span
                      key={idx}
                      className={`px-2 py-0.5 rounded bg-background border border-border ${activeAgent.badgeText} font-mono`}
                    >
                      ⚡ {tool}
                    </span>
                  ))}
          ...
          >
            <div className="p-5 rounded-xl bg-card border border-border space-y-2.5 shadow-sm">
              <div className="w-9 h-9 rounded bg-category-arch/15 text-category-arch border border-category-arch/30 flex items-center justify-center">
                <Box className="w-4 h-4" />
              </div>
              <h3 className="text-sm font-bold text-foreground font-display">Symbol Graph Extraction</h3>
            ...
            <div className="p-5 rounded-xl bg-card border border-border space-y-2.5 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-foreground font-display">Self-Correction Quality Gate</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="p-5 rounded-xl bg-card border border-border space-y-2.5 shadow-sm">
              ...
              <h3 className="text-sm font-bold text-foreground font-display">Explainability & Source Line Evidence</h3>
              <p className="text-xs text-muted-foreground leading-relaxed">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-border py-6 bg-card font-mono text-xs text-muted-foreground">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/RepoMind_AI_logo.jpeg" alt="Logo" className="w-4 h-4 rounded object-cover" />
            <span className="text-foreground font-bold">RepoMind AI</span>
            <span>— Autonomous Repository Audit Workspace</span>
          </div>

          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded bg-background border border-border text-[11px]">LangGraph</span>
            <span className="px-2 py-0.5 rounded bg-background border border-border text-[11px]">FastAPI</span>
            <span className="px-2 py-0.5 rounded bg-background border border-border text-[11px]">3D WebGL</span>
          </div>
        </div>
      </footer>
    </div>
